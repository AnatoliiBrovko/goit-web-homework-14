...
class TestContacts(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        self.test_contact = Contact(
            ...
            first_name='Qwerty',
            last_name='Asdf',
            email='Qwerty@meta.com',
            phone_number="+3800000000",
            date_of_birth=datetime.date(year=2002, month=2, day=2)
        )
    ...
    async def test_get_contacts_birthdays(self):
        ...
        today = date.today()
        contacts = [
            Contact(id=1, first_name='Qwerty', last_name='Asdf',
                    email='Qwerty@meta.com', date_of_birth=today),
            Contact(id=2, first_name='test', last_name='testtest',
                    email='test@example.net', date_of_birth=today),
        ]
        self.session.query().filter().offset().limit().all.return_value = contacts
